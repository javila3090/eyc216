                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <ul class="nav nav-tabs nav-tabs--vertical nav-tabs--left" role="navigation" style="letter-spacing: 1px">
                                <li class="nav-item">
                                    <a href="#tab_1" class="nav-link" data-toggle="tab" role="tab" aria-controls="tab_1">{{$kinesiologist->title}}</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#tab_2" class="nav-link active" data-toggle="tab" role="tab" aria-controls="tab_2">Áreas de la kinesiología</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                <div class="tab-pane fade" id="tab_1" role="tabpanel" style="padding: 20px;">
                                    <h2>{{$kinesiologist->title}}</h2>
                                    <br>
                                    {!!$kinesiologist->content!!}
                                </div>
                                <div class="tab-pane fade show active" id="tab_2" role="tabpanel" style="padding: 20px;">
