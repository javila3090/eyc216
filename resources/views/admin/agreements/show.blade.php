        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-info card-outline">
                    ...
                    <!-- /.card-header -->
                    {!! Form::model($agreement,['route' => ['update_section', $agreement], 'method' => 'PUT','enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="subject" class="col-md-4 col-form-label text-md-right">{{ __('Comuna') }}</label>
                            <div class="col-md-6">
                                {!! Form::text('commune', null, ['class' => 'form-control' ,'readonly'=>'true']) !!}  
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="subject" class="col-md-4 col-form-label text-md-right">{{ __('Dirección') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="subject" class="col-md-4 col-form-label text-md-right">{{ __('Empresa/Institución') }}</label>
                            <div class="col-md-6">
