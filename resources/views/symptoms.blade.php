                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <ul class="nav nav-tabs nav-tabs--vertical nav-tabs--left" role="navigation" style="letter-spacing: 1px">
                                ...
                                <li class="nav-item">
                                    <a href="#tab_4" class="nav-link active" data-toggle="tab" role="tab" aria-controls="tab_4">Síntomas y dolores</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="tab_4" role="tabpanel" style="padding: 20px;">
