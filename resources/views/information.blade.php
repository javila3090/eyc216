                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <ul class="nav nav-tabs nav-tabs--vertical nav-tabs--left" role="navigation" style="letter-spacing: 1px">
                                ...
                                <li class="nav-item">
                                    <a href="#tab_3" class="nav-link active" data-toggle="tab" role="tab" aria-controls="tab_3">Información útil</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="tab_3" role="tabpanel" style="padding: 20px;">
